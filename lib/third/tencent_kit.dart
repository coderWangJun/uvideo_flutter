...
class TencentKit {
  ...
  Future<void> initSdk() async {
    await TencentImPlugin.init(
        appid: "1400432555", logPrintLevel: LogPrintLevel.error);
//      _loginWithCurrentUser();
    bool _isLogin = await AccountManager.instance.isLogin;
    if (_isLogin == null || !_isLogin) return;

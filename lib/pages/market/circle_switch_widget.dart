...
class CircleSwitchWidget extends StatefulWidget {
  ...
  @override
  _CircleSwitchWidgetState createState() => _CircleSwitchWidgetState(marketPostListProvider,uri,map);
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          GestureDetector(behavior: HitTestBehavior.opaque,child:UiUtil.getContainer(20.0, 10.0, selectCircle?UiUtil.getColor(76,num1: 152,num2: 244):UiUtil.getColor(238),
            Text('圈内', textAlign: TextAlign.center, style: selectCircle?UiUtil.getTextStyle(255, 11.0):UiUtil.getTextStyle(10, 11.0)),
              mWidth: 40.0),onTap: (){
            if(!selectCircle){
              setState(() {
                selectCircle = true;
          ...
          GestureDetector(behavior: HitTestBehavior.opaque,child:UiUtil.getContainer(20.0, 10.0, !selectCircle?UiUtil.getColor(76,num1: 152,num2: 244):UiUtil.getColor(238),
            Text('圈外', textAlign: TextAlign.center, style: !selectCircle?UiUtil.getTextStyle(255, 11.0):UiUtil.getTextStyle(10, 11.0)),
              mWidth: 40.0),onTap: (){
            if(selectCircle){
              setState(() {
                selectCircle = false;

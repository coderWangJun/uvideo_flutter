...
//          }
  ...
  Widget _buildVideoButtonSelected() {
    return Container(
        ...
        child: Container(
          ...
          child: ClipRRect(
            borderRadius: BorderRadius.circular(8),
            child: Image.file(File(_thumbImagePath), width: 160, height: 185, fit: BoxFit.cover),
          ),
        )
    );
  }
          ...
          Expanded(
            child: InkWell(
              child: Container(
                ...
                child: Text('普通发布', style: TextStyle(fontSize: 17, color: ColorConstants.textColor153)),
              ),
              onTap: () {
                _saveShortVideo(0);
              },
          ...
          Expanded(
            child: InkWell(
              child: Container(
                ...
                child: Text('收费发布', style: TextStyle(fontSize: 17, color: Colors.white)),
              ),
              onTap: () async {
  ...
  void _saveShortVideo(int coint) {
    ...
    DioUtil.request("/user/uploadMediaWorks", parameters: formData).then((responseData) {

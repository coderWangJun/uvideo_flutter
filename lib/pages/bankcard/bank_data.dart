class BankData{
  ...
  static final List<String> _bankBin = [
    ...
    "623251", "628351" ];
      ...
      static final List<String> _bankName = [
    ...
    static String findBankName(String cardId){
      int index = -1;
      if(cardId == null || cardId.length<16 || cardId.length>19){
        return "";
      }

      String cardBin6 = cardId.substring(0,6);
      for (int i = 0; i < _bankBin.length; i++) {
        if (cardBin6 == _bankBin[i]){
          index = i;
        }
      }
      if (index != -1) {
        return _bankName[index];
      }

      //8位Bin号
      String cardBin8 = cardId.substring(0, 8);
      for (int i = 0; i < _bankBin.length; i++) {
        if (cardBin8==_bankBin[i]) {
          index = i;
        }
      }
      if (index != -1) {

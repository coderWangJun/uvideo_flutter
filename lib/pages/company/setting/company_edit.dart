  ...
  Widget _getBody(BuildContext context, CompanyEditAllProvider model) {
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          "${model.proValueTitle}${model.proValue}%",
          style: TextStyle(
              color: Color.fromRGBO(51, 51, 51, 1),
              fontSize: 13.0,
              fontWeight: FontWeight.w500),
        ...
        GestureDetector(
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                  bottom: BorderSide(
                      color: Color.fromRGBO(238, 238, 238, 0.5), width: 1.0)),
            ),
            child: Row(
        ...
        Container(
          ...
          child: Text(
            "基本信息${model.proAll}/${model.proAllMAx}",
            style: TextStyle(
                color: Color.fromRGBO(51, 51, 51, 1),
                fontWeight: FontWeight.bold,
                fontSize: 15.0),
        ...
        GestureDetector(
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                model.corporateWelfare != null &&
                        model.corporateWelfare.isNotEmpty
                    ? Text(
                        model.corporateWelfare,
                        style: TextStyle(
                            fontSize: 15.0,
          ...
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) {
              return inputTextFild("公司福利", model.corporateWelfare);
            })).then((value) {
              model.changeCorporateWelfare(value);
            });
          },
        ),
        ...
        GestureDetector(
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                model.productIntroduction != null &&
                        model.productIntroduction.isNotEmpty
                    ? Text(
                        model.productIntroduction,
                        style: TextStyle(
                            fontSize: 15.0,
                            color: Color.fromRGBO(51, 51, 51, 0.5)),
                      )
                    : model.getStringStatus("未添加"),
                SizedBox(
                  width: 10.0,
                ),
                Container(
          ...
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) {
              return inputTextFild("产品介绍", model.productIntroduction);
            })).then((value) {
              model.changeProductIntroduction(value);
            });
          },
        ),
        ...
        GestureDetector(
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                (model.financingStage != null && model.financingStage != "")
                    ? Text(model.financingStage, style: _itemTextStyle)
                    : model.getStringStatus("未完善"),
                SizedBox(
                  width: 10.0,
                ),
          ...
          onTap: () {
            ...
            showDialog(
                ...
                context: context,
                builder: (context) {
                  return ChooseScrollFragment(
                    data,
                    defIndex: model.financingStageNo,
                  );
                }).then((value) {
              if (value != null) {
                model.changeFinancingStage(
                    model.dataFinancing[value + 1]["index"] as num);
              }
            });
          },
        ),
        ...
        GestureDetector(
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                (model.staffScaleName != "" && model.staffScaleName != null)
                    ? Text(model.staffScaleName, style: _itemTextStyle)
                    : model.getStringStatus("未完善"),
                SizedBox(
                  width: 10.0,
                ),
          ...
          onTap: () {
            ...
            showDialog(
                ...
                context: context,
                builder: (context) {
                  return ChooseScrollFragment(data,
                      defIndex: model.staffScaleNameNo);
                }).then((value) {
              if (value != null) {
                model.changeStaffScaleName(
                    model.dataStaff[value + 1]["index"] as num);
              }
            });
          },
        ),
